...
public class Generator {
    // 数据库连接字段配置
    private static final String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/qpay_standalone?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai&&useSSL=false";
    private static final String JDBC_USER_NAME = "root";
    private static final String JDBC_PASSWORD = "2548316766";

    // 包名和模块名
    private static final String PACKAGE_NAME = "com.sccysoft.qpay";
    private static final String MODULE_NAME = "";

    // 表名,多个表使用英文逗号分割
    private static final String[] TBL_NAMES = {"bank_transaction_info"};
        ...
        */
        ...
        fastAutoGenerator.strategyConfig(
                strategyConfigBuilder -> strategyConfigBuilder.entityBuilder()
                        ...
                        .idType(IdType.ASSIGN_ID)    // 全局主键类型为ASSIGN_ID(雪花片)//AUTO(自增)
                        ...
                        .formatFileName("%sPO") // 实体名称格式化为XXXEntity   formatFileName("%sEntity")
        );
